...
public class RequestConstant {
    ...
    public static final String ENGINE_CAPACITY1 = "engine_capacity1";
    public static final String ENGINE_CAPACITY2 = "engine_capacity2";
    public static final String TRANSMISSION = "transmission";
    public static final String YEAR = "year";
    public static final String DRIVE = "drive";
    public static final String TANK = "tank";
    public static final String CONSUMPTION = "consumption";
    public static final String CONSUMPTION1 = "consumption1";
    public static final String CONSUMPTION2 = "consumption2";
    ...
    public static final String CURRENT_DATE_PLUS = "currentDatePlus";
